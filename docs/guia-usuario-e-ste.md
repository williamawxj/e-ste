...
> **Atenção:** a numeração de aula de cada matéria (o número mostrado em "8(20)") é sempre calculada automaticamente e nunca precisa de ajuste manual durante o preenchimento. Se em algum momento um número de aula foi definido manualmente e ficou menor ou igual ao de uma aula anterior na mesma matéria, o sistema corrige isso sozinho ao confirmar o QTS, ajustando para o próximo número da sequência.
